...
class IconLinkSpan(
    val linkDrawable: Drawable,
    @Px val padding: Float = 16f,
...
//        paint.forIcon {
        canvas.translate(x + padding / 2f, transY.toFloat())
